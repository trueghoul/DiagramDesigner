...
namespace DiagramDesigner
{
    public class EllipseDesignerItemViewModel : DesignerItemViewModelBase, ISupportDataChanges
    {
        ...
        public EllipseDesignerItemViewModel(int id, IDiagramViewModel parent, double left, double top, string text, int fontSize, Brush stroke, double strokeThickness)
        ...
        public EllipseDesignerItemViewModel(int id, IDiagramViewModel parent, double left, double top, double itemWidth, double itemHeight, string text, int fontSize, Brush stroke, double strokeThickness)
